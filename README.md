...
`subagent_status`, `subagent_control resume`, and a new dispatch before it takes
an id — so the first call after a reload can never report parked work as missing
